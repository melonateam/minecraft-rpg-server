...
function HelpContent() {
  return (
    <div className="space-y-4 p-6 text-sm text-[#c7d2dc]">
      ...
      <Help title="변수">
        대사 안에서 <code className="rounded bg-black/25 px-1.5 py-0.5 text-[#9d8cff]">{'{{변수명}}'}</code>을 사용하면 플레이어별 변수 값을 출력할 수 있습니다. 효과에서 <code className="rounded bg-black/25 px-1.5 py-0.5">score+=1</code> 또는 <code className="rounded bg-black/25 px-1.5 py-0.5">roll=random(1..10)</code> 같은 연산을 사용할 수 있습니다.
      </Help>
      <Help title="서버 동기화">
